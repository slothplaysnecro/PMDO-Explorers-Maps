...
--require 'PMDOEMAPS.PartnerEssentials'
...
if not skipQuiz then
  ...
  for i = 1, 16, 1 do
	...
	GAME:WaitFrames(1)
	UI:BeginChoiceMenu(STRINGS:Format(STRINGS.MapStrings['Quiz_Q'..tostring(currentQ[rand])..'_A0']), choices, 1, 3)
	UI:WaitForChoice()
...
GAME:WaitFrames(30)
UI:SetCenter(true)
UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Quiz_Result'], _DATA:GetMonster(pkm.Species):GetColoredName()))
UI:SetCenter(false)
